<?php    
    if(!$TDV->segurity($modulo, $TDV->getArrayModules())){
        ...
        $SERVICIOS = '';
        $res = $ui->conn->query("SELECT idServicio, titulo FROM tdv_servicios_cultos ORDER BY titulo DESC");
        while ($rs = $res->fetch_assoc()) {
...
?>
    <style>
        ...
        /*#snapshot{background: url(images/none.png);width: 100%;}*/
    </style>
                ...
                <div class="register">
                    <div class="row">
                        ...
                        <div class="col-md-9 register-right">
                            <div class="content">
                                <form id="frmRegisteVisita" action="server/addVisita.php">
                                    <div class="row register-form">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Nombre *" id="txtNombre" name="txt_nombre" value="" disabled required />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Apellidos *" id="txtApellidos" name="txt_apellidos" value="" disabled required />
                                            </div>
                                            <div class="form-group">
                                                <input type="email" class="form-control" placeholder="Email *" id="txtEmail" name="txt_email" value="" disabled required />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" minlength="9" maxlength="15" id="txtTelefono" name="txt_telefono" class="form-control" placeholder="Teléfono *" value="" disabled required />
                                            </div>
                                            <div class="form-group">
                                                <select class="form-control" id="txtSexo" name="txt_sexo" style="width: 100%;height: 45px;" disabled>
                                            ...
                                            <div class="form-group">
                                                <textarea disabled class="form-control" id="txtDireccion" name="txt_direccion" placeholder="Dirección"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="txt_idTipoMiembro" style="width: 100%;"> Tipo <br>
                                                    <select class="form-control" id="txt_idTipoMiembro" name="txt_idTipoMiembro" required style="width: 100%;height: 45px;" disabled>
                                            ...
                                            <div class="form-group">
                                                <label for="txt_idDepartamento" style="width: 100%;"> Departamento <br>
                                                    <select class="form-control" id="txt_idDepartamento" name="txt_idDepartamento" required style="width: 100%;height: 45px;" disabled>
                                            ...
                                            <div class="form-group">
                                                <label for="txt_idCulto" style="width: 100%;"> Servicio culto <br>
                                                    <select class="form-control" id="txt_idCulto" name="txt_idCulto" required style="width: 100%;height: 45px;" disabled>
                                                        <option value="">Seleccionar</option>
                                                        <?=$SERVICIOS?>
                                                    </select>
                                                </label>
                                            ...
                                            <input type="submit" class="btnRegister" onclick="setDisableForm();" value="Registrar Visita"/>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
?>
        ...
        <div class="modal-dialog  modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="$('#ProteccionDatosModal').modal('hide'); setEnableForm();">ACCEPTO</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            $("#frmRegisteVisita").submit(function(e) {
                ...
                $.ajax({
                    ...
                    url: 'server/miembros/saveVisita.php',
                    dataType: 'json',
                    data: data,
                    contentType: false,
                    processData: false,
        ...
        function setEnableForm(){
            ...
            $( "#txtSexo" ).prop( "disabled", false );
            $( "#txtDireccion" ).prop( "disabled", false );
            $( "#txt_idDepartamento" ).prop( "disabled", false );
            $( "#txt_idCulto" ).prop( "disabled", false );
        ...
        function setDisableForm(){
            ...
            $( "#txtSexo" ).prop( "disabled", true );
            $( "#txtDireccion" ).prop( "disabled", true );
            $( "#txt_idDepartamento" ).prop( "disabled", true );
            $( "#txt_idCulto" ).prop( "disabled", true );
