    ...
    if(!$TDV->segurity($modulo, $TDV->getArrayModules())){
        ...
        $BOTON = '<div class="pr-1 mb-3 mb-xl-0">
                    <button type="button" class="btn btn-outline-inverse-info btn-icon-text" data-toggle="modal" data-target="#modalMiembrosForm" onclick="TDV.restarForm(\'frm_miembros\');"> 
                        Crear miembro Escuela Dominical <i class="mdi mdi-book-plus"></i>                          
                    </button>
                </div>';

        echo $ui->tdv_welcome_panel($BOTON, "Escuela Dominical");
        

        $res = $TDV->conn->query("SELECT * FROM tdv_miembros WHERE idDepartamento = 5 ORDER BY apellidos ASC");
                            ...
                            <div class="frontside">
                                <div class="card" style="margin-top: 20px;">
                                    <div class="card-body text-center" style="padding: 5px;">
                                        <p><img class=" img-fluid" src="data:'.$rs["imgBase64"].'" alt="image" onerror="this.src=\'images/none.png\'" alt="card image" style="height:100%;"></p>
