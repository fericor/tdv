...
-- Tiempo de generación: 20-07-2020 a las 09:53:05
...
--
ALTER TABLE `tdv_grupo_vida_casas`
  MODIFY `idCasa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT de la tabla `tdv_grupo_vida_distritos`
--
ALTER TABLE `tdv_grupo_vida_distritos`
  MODIFY `idDistrito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `tdv_lista_miembros`
  MODIFY `idListaGrupo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `tdv_miembros`
  MODIFY `idMiembro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tdv_tipos_miembros`
  MODIFY `idTipoMiembro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
