...
error_reporting(E_ALL);
    ...
    $ID   = $_POST["tdv_id"];
    $SQL  = "SELECT tb1.*, tb2.titulo as DEPARTAMENTO, tb3.titulo AS TIPOMIEMBRO, tb4.titulo AS DISTRITO, tb5.titulo AS ZONA, tb6.titulo AS BARRIO, tb7.direccion AS DIRECCIONCASA FROM tdv_miembros2 AS tb1";
